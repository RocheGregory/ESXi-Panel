...
async function applianceWorkflow(cisService) {
   console.log("Storages", await cisService.applmgmt.system.storage.list());
}
...
async function sample(hostname, username, password) {
   ...
   try {
      ...
      await vimService.vimPort.loginByToken(
            vimService.serviceContent.sessionManager, null);
      ...
      await applianceWorkflow(cisService);
